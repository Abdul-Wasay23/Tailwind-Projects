# Tailwind Projects (HTML & Tailwind CSS)

Collection of frontend projects built using **HTML and Tailwind CSS**, focused on clean UI, modern layouts, and responsive design.
